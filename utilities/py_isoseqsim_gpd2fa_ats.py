...
def do_inputs():
	parser = argparse.ArgumentParser(description="Generate fasta sequence for each isoform. Note: the isoform is renamed as 'isoform ID' + 'TSS'", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
