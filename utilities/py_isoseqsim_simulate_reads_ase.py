...
def do_inputs():
	parser = argparse.ArgumentParser(description="Simulate ASE-specific reads.", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
	parser.add_argument('-g','--input_gpd',type=argparse.FileType('r'),required=True,help="Input: gpd file with total read count, allele1 read count, allele2 read count in last 3 columns")
	parser.add_argument('-t','--input_fa',type=argparse.FileType('r'),required=True,help="Input: ASE-specific transcriptome fasta file")
